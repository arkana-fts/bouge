...
macro(bouge_static_add_libraries target)
...
# add a new target which is a bouge library
# ex: bouge_add_library(bouge-libxml
#                      SOURCES bla.cpp bli.cpp ...
#                      DEPENDS bouge
#                      EXTERNAL_LIBS xml ...)
macro(bouge_add_library target)
    ...
    # link the target to its internal dependencies
    if(THIS_DEPENDS)
    ...
    if(THIS_EXTERNAL_LIBS)
        if(BUILD_SHARED_LIBS)
            ...
            bouge_static_add_libraries(${target} ${THIS_EXTERNAL_LIBS})
        endif()
    endif()
...
# ex: bouge_add_example(io
#                       SOURCES io.cpp ...
#                       DEPENDS bouge bouge-math bouge-xmlio bouge-tinyxml)
macro(bouge_add_example target)
    ...
    # link the target to its bouge dependencies
    if(THIS_DEPENDS)
        target_link_libraries(${target} ${THIS_DEPENDS})
    endif()
