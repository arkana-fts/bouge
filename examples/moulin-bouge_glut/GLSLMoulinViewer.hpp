...
//
////////////////////////////////////////////////////////////
#ifndef D_BOUGEEXAMPLE_MOULIN_GLSLVIEWER_HPP
#define D_BOUGEEXAMPLE_MOULIN_GLSLVIEWER_HPP
...
namespace bougeExample {
    ...
    class GLSLMoulinViewer : public Viewer
    {
    public:
        GLSLMoulinViewer(std::vector<std::string>& args);
        virtual ~GLSLMoulinViewer();
...
#endif // D_BOUGEEXAMPLE_MOULIN_GLSLVIEWER_HPP
