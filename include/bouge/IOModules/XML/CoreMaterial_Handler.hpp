...
//
////////////////////////////////////////////////////////////
#ifndef BOUGE_COREMATERIAL_XMLHANDLER_HPP
#define BOUGE_COREMATERIAL_XMLHANDLER_HPP
...
namespace bouge {
    ...
    class CoreMaterial_XMLHandler : public XMLHandler
    {
    public:
        CoreMaterial_XMLHandler(std::vector<CoreMaterialPtr>& materialsToLoad);
        virtual ~CoreMaterial_XMLHandler();
...
#endif // BOUGE_COREMATERIAL_XMLHANDLER_HPP
